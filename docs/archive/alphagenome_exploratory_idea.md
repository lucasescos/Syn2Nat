# Historical Scratchpad: Exploratory AlphaGenome Microprotein Screening Plan

> [!NOTE]
> **Status: Historical / Completed Exploratory Phase**  
> This document was an early exploratory concept for batch querying the AlphaGenome API across human microproteins.  
> **Superseding Documentation**:
> - Full Empirical Results & Hitchhiking Proof: [`reports/microprotein_multiomics_analysis_report.md`](../../reports/microprotein_multiomics_analysis_report.md)
> - Comprehensive Master Synthesis: [`PROJECT_MASTER_DOCUMENT.md`](../../PROJECT_MASTER_DOCUMENT.md#2-multi-omics-selection--resolution-of-the-hitchhiking-confounder)
> - Executed Pipeline Scripts: [`scripts/step1_extract_intervals.py`](../../scripts/step1_extract_intervals.py) through [`scripts/step4_single_variant_analysis.py`](../../scripts/step4_single_variant_analysis.py)
